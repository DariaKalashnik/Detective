...
public class SolveProblem3 extends AppCompatActivity {
    ...
    public void onRadioClick3(View v) {
        ...
        switch (v.getId()) {
            case R.id.radioQ11:
                answerIntent3.putExtra(CRIME3, "Correct. You are brilliant detective!");
                break;
            case R.id.radioQ12:
                answerIntent3.putExtra(CRIME3, "Wrong answer");
                break;
            case R.id.radioQ13:
                answerIntent3.putExtra(CRIME3, "It is not a fantasy series");
                break;
            case R.id.radioQ14:
                answerIntent3.putExtra(CRIME3, "Important issue, but not at this time");
                break;
            case R.id.radioQ15:
                answerIntent3.putExtra(CRIME3, "And we all miss him, but the answer is incorrect");
                break;
